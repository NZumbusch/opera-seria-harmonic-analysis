...
SCHEMA_LIBRARY = {
    ...
    "ROMENESCA": SchemaDefinition(
        ...
        sections=[
            ...
            SchemaSection(bass_major=11, bass_minor=10, soprano_major=7, soprano_minor=7),
    ...
    "DOREMI": SchemaDefinition(
        ...
        sections=[
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=0, soprano_minor=0),
            SchemaSection(bass_major=11, bass_minor=11, soprano_major=2, soprano_minor=2),
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=4, soprano_minor=3),
        ]
    ),
    "MONTE": SchemaDefinition(
        ...
        sections=[
            ...
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=4, soprano_minor=3),
            SchemaSection(bass_major=11, bass_minor=11, soprano_major=5, soprano_minor=5),
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=4, soprano_minor=3), # should it go to major or minor?
        ]
    ),
    "MEYER": SchemaDefinition(
        ...
        sections=[
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=0, soprano_minor=0),
            SchemaSection(bass_major=2, bass_minor=2, soprano_major=11, soprano_minor=11),
            SchemaSection(bass_major=11, bass_minor=11, soprano_major=5, soprano_minor=5),
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=4, soprano_minor=3),
        ]
    ),
    "QUIESCENZA": SchemaDefinition(
        name="Quiescenza", 
        sections=[
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=10, soprano_minor=10), # what is this in minor?
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=9, soprano_minor=9),
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=11, soprano_minor=11),
            SchemaSection(bass_major=0, bass_minor=0, soprano_major=0, soprano_minor=0),
        ]
    ),
